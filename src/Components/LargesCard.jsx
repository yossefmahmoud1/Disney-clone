...
function LargesCard({ movie }) {
  ...
  return (
    <Link to={`/movie/${movie.id}`} className="group">
      <div className="relative transition-all duration-150 ease-in hover:scale-110">
        <img
          src={IMAGE_BASE_URL + movie.poster_path}
          className="w-[120px] sm:w-[140px] md:w-[260px] lg:w-[320px] xl:w-[380px] rounded-lg hover:border-[3px] border-gray-500 cursor-pointer"
        ...
        <h2 className="w-[120px] sm:w-[140px] md:w-[260px] lg:w-[320px] xl:w-[380px] text-white mt-1.5 sm:mt-2 text-xs sm:text-sm md:text-base font-medium leading-tight">
