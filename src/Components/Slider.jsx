...
function Slider() {
    ...
    return (
        <div className="relative z-10 overflow-hidden">
            ...
            onClick={() => sliderleft(element_refrennce.current)} />

            <HiChevronRight className='hidden md:block text-white text-[30px] absolute
            mx-8 mt-[150px] cursor-pointer right-0' 
            onClick={() => sliderRight(element_refrennce.current)} />

            <div className='flex overflow-x-auto w-full px-16 py-4 scrollbar-hide scroll-smooth' ref={element_refrennce}>
